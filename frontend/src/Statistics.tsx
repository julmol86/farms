        ...
        <>
          <div className = "mt-4">
            <Form.Group className="mb-3 col-lg-3 col-md-6">
              ...
              <Form.Select defaultValue="" data-testid='statistics-farm' onChange={(e) => setFarmId(e.target.value)}>
            ...
            <Form.Group className="mb-3 col-lg-3 col-md-6">
              ...
              <Form.Select defaultValue="" data-testid='statistics-metrictype' onChange={(e) => setMetricType(e.target.value)}>
            ...
            <Form.Group className="mb-3 col-lg-3 col-md-6">
              ...
              <Form.Select defaultValue="" data-testid='statistics-month' onChange={(e) => setMonth(e.target.value)}>
            ...
            <Form.Group className="mb-3 col-lg-3 col-md-6">
              ...
              <Form.Control defaultValue="" data-testid='statistics-startdate' type="date" onChange={(e) => setStartDate(e.target.value)} disabled={!!month}/>
            </Form.Group>

            <Form.Group className="mb-3 col-lg-3 col-md-6">
              <Form.Label>{t('stat.form.enddate')}</Form.Label>
              <Form.Control defaultValue="" data-testid='statistics-enddate' type="date" onChange={(e) => setEndDate(e.target.value)} disabled={!!month}/>
            </Form.Group>
